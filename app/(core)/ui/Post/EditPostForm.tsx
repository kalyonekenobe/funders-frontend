        ...
        await Promise.all(
          ...
          setState(prevState => ({
            ...
            data: {
              ...
              categories: (post.categoriesToPosts || []).map(categoryToPost => ({
                name: categoryToPost.category,
              })),
              attachments,
            },
          }));
                ...
                <input
                  ...
                  onChange={event =>
                    setState({
                      ...
                      data: {
                        ...state.data,
                        isDraft: event.target.checked ? Boolean(event.target.checked) : false,
                      },
                      errors: {
                        ...state.errors,
                        nested: Object.fromEntries(
